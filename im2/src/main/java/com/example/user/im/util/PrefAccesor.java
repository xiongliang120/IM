 ...
 * <p/>
 * Created by xiongl on 2016/7/16..
 * ClassName  :
 * Description  :
 */
public class PrefAccesor {
    /**
     * share preference file to save
     */
    public static final String SHARE_DATA_FILE_NAME = "stay4it";

    private static PrefAccesor instance = null;
    private SharedPreferences mSharedPreferences;

    private PrefAccesor(Context context) {
        mSharedPreferences = context.getSharedPreferences(SHARE_DATA_FILE_NAME, Context.MODE_PRIVATE);
    }

    public synchronized static PrefAccesor getInstance(Context context) {
        if (instance == null) {
            instance = new PrefAccesor(context);
        }
        return instance;
    }
